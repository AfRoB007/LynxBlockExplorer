...
!function(i){"use strict";i(document).ready(function(){if(i(document).ajaxError(function(e,a,t,s){var n='<div role="alert" class="mt-4 alert alert-danger alert-dismissable">';n+='<button type="button" data-dismiss="alert" class="close">×</button>',n+="<strong>"+a.responseJSON.message+"</strong>",n+="</div>",i("#error-place-holder").html(n)}),setInterval(function(){-1===window.location.pathname.indexOf("markets")&&i.ajax({url:"/data/recent-block",contentType:"application/json",dataType:"json",type:"GET"}).done(function(e){i("#block_number").html(e.blockIndex)})},15e3),i(".menu-trigger").length&&i(".menu-trigger").click(function(){i(this).toggleClass("active"),i(".header-area .nav").slideToggle(200)}),i("body").click(function(e){var a=e.target;i(a).parents(".flag-list").length||i(a).hasClass("flag-list")||("block"!==i(".flag-list").css("display")?(i(a).hasClass("selected")||i(a).parents(".selected").length)&&i(".flag-list").css("display","block"):i(".flag-list").css("display","none"))}),i(".token-progress ul").length){i(".token-progress ul").find(".item").each(function(e){i(".token-progress ul .item:eq("+[e]+")").css("left",i(".token-progress ul .item:eq("+[e]+")").data("position"))});var e=i(".token-progress ul .progress-active").data("progress");i(".token-progress ul .progress-active").css("width",e)}particlesJS("particles-js",{particles:{number:{value:80,density:{enable:!0,value_area:800}},color:{value:"#ffffff"},shape:{type:"circle",stroke:{width:0,color:"#000000"},polygon:{nb_sides:5},image:{src:"img/github.svg",width:100,height:100}},opacity:{value:.5,random:!1,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:5,random:!0,anim:{enable:!1,speed:40,size_min:.1,sync:!1}},line_linked:{enable:!0,distance:150,color:"#ffffff",opacity:.4,width:1},move:{enable:!0,speed:6,direction:"none",random:!1,straight:!1,out_mode:"out",attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:!0,mode:"repulse"},onclick:{enable:!0,mode:"push"},resize:!0},modes:{grab:{distance:400,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:200},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0,config_demo:{hide_card:!1,background_color:"#b61924",background_image:"",background_position:"50% 50%",background_repeat:"no-repeat",background_size:"cover"}})}),i(window).load(function(){i(".loading-wrapper").animate({opacity:"0"},600,function(){setTimeout(function(){i(".loading-wrapper").css("visibility","hidden").fadeOut(),i(".parallax").length&&i(".parallax").parallax({imageSrc:"assets/images/parallax.jpg",zIndex:"1"})},300)})}),i(window).scroll(function(){991<i(window).width()&&(30<=i(window).scrollTop()?i(".header-area").addClass("header-sticky"):i(".header-area").removeClass("header-sticky"))})}(jQuery);
